...
def train_model_random(train_data_file: str, output_dir: str):
...
def _train_log_randomfores(df: pd.DataFrame):
    ...
    print(data)
    data.to_csv(r'..\Data\test\export_random.csv', index=False,header=True)
...
if __name__ == '__main__':
    ...
    train_model_random(train_path, output_path)